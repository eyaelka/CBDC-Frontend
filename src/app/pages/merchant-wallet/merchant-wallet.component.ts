...
import { ChartType, ChatMessage } from './merchant-wallet.model';
import { ConfigService } from '../../core/services/config.service';
@Component({
  selector: 'app-merchant-wallet',
  templateUrl: './merchant-wallet.component.html',
  styleUrls: ['./merchant-wallet.component.scss']
})
export class MerchantWalletComponent implements OnInit,AfterViewInit {
